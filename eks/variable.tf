...
variable "large_asg_max_size" { default = 6 }
...
variable "gitlab_ci_runner_medium_asg_min_size" { default = 1 }
variable "gitlab_ci_runner_medium_asg_desired_capacity" { default = 1 }
